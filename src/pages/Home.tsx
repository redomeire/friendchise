    ...
    return (
        <AppLayout>
            ...
            onScroll={() => { console.log('scrolled') }} ref={parallax} pages={1} style={{ top: '40px', left: '0', scrollbarWidth: 'none' }} className={scrollbar.scrollbar_hide} innerStyle={{ overflow: 'unset', scrollbarWidth: 'none' }}>
                ...
                <ParallaxLayer offset={0} speed={3} className="z-50" style={{ top: '100px' }}>
                ...
                <ParallaxLayer offset={0} speed={2.7} className="z-40 opacity-80" style={{ top: '180px' }}>
                    <img src={Layer2} className="w-full"></img>
                </ParallaxLayer>
                <ParallaxLayer offset={0} speed={2.3} className="z-30" style={{ top: '250px' }}>
                    <img src={Layer3} className="w-full"></img>
                </ParallaxLayer>
                <ParallaxLayer offset={0} speed={2} className="z-20" style={{ top: '230px' }}>
                    <img src={Layer4} className="w-full"></img>
                </ParallaxLayer>
                <ParallaxLayer offset={0} speed={1.7} className="z-10" style={{ top: '130px' }}>
