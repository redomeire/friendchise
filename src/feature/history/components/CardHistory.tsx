...
const CardHistory = () => {
    ...
    return (
        <div onClick={() => { navigate('/waralaba/1') }} className="p-5 rounded-xl border-[1.5px] border-gray-300 my-3 cursor-pointer hover:shadow-lg transition duration-200">
            ...
            <div className="w-full mt-5 flex items-stretch md:flex-row flex-col justify-between">
                <div className="flex items-center">
