    ...
    return ( 
        <main className="p-10 px-40 bg-primary mt-20 w-full text-white">
            ...
            <div className="flex items-center justify-between mt-20">
                ...
                <img src={Home1} className="md:w-[25%] bg-cover bg-center rounded-xl"/>
            </div>
            <div className="flex flex-row-reverse items-center justify-between mt-20">
                ...
                <img src={Home2} className="md:w-[25%] bg-cover bg-center rounded-xl"/>
            </div>
            <div className="flex items-center justify-between mt-20">
                <div className="md:w-[50%]">
                ...
                <img src={Home3} className="md:w-[25%] bg-cover bg-center rounded-xl"/>
            </div>
        </main>
     );
}
